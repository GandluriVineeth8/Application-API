...
app.get('/todos1', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos2/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos3/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos4/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos5/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos6/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
...
app.get('/todos7/', checkRequestsQueries, async (request, response) => {
  const {
    status = '',
    search_q = '',
    priority = '',
  ...
  const getTodosQuery = `
        SELECT 
            ...
            due_date AS dueData  
        FROM 
            todo WHERE category='${category}' AND priority='${priority}';`
